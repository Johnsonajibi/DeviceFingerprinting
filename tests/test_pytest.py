...
def test_token_binding_and_verification():
    ...
    original_token: Dict[str, Any] = {"user_id": "pytest_user", "data": "some_secret_data"}
...
def test_token_binding_with_pqc():
    ...
    original_token: Dict[str, Any] = {"user_id": "pytest_pqc_user", "data": "pqc_secret_data"}
...
def test_fingerprint_stability(
    fingerprinter: AdvancedDeviceFingerprinter, method: FingerprintMethod
):
